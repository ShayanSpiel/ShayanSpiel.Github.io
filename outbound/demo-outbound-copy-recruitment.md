# Demo Outbound Copy - Recruitment Suppliers (T2)

**Campaign:** Recruitment-Demo Outreach
**Total leads:** 1,120 (1,120 valid emails, all publicly listed)
**Top countries:** UK 798, Canada 55, UAE 50, Ireland 47, Australia 29, US 20, NZ 16, Singapore 11, Sweden 8, Finland 8
...
## Personalization data per lead

- **Research signal:** use `personalization_hook` (role reference) from `/tmp/recruitment_leads.csv`
- **Richer signals:** ~82 leads have `research_fact` + `buying_signals` populated - use those for stronger hooks
- **Emotional endings:** pick from - that's smart, that's interesting, that's a lot of work, what a portfolio, that resonates
