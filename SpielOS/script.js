/* =====================================================================
   Spiel OS, Landing Page Interactions
   ===================================================================== */
...
function setupCopy(boxId, btnId) {
  ...
  if (!box || !btn) return;
  function cp() {
    try { navigator.clipboard.writeText('curl -fsSL https://spielos.xyz/install | bash'); }
    catch(e) { var t=document.createElement('textarea'); t.value='curl -fsSL https://spielos.xyz/install | bash'; document.body.appendChild(t); t.select(); document.execCommand('copy'); document.body.removeChild(t); }
