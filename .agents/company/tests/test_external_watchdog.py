...
1. Supervisor: `.agents/company/runtime/supervisor.py --check` runs one
...
SUPERVISOR_SCRIPT = REPO_ROOT / ".agents/company/runtime/supervisor.py"
...
class DispatchRetryLedgerTests(unittest.TestCase):
    ...
    def test_dispatch_cli_record_and_list_roundtrip(self):
        ...
        env = {**os.environ, "PYTHONDONTWRITEBYTECODE": "1", "PYTHONPATH": ".agents"}
