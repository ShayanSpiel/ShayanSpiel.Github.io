...
ACCEPTANCE_PREFIX = "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=.agents python3 -B -m unittest "
FEATURE_MODULES = (
...
ALLOWED_FILES = [
    ".agents/company/tests/test_approval_policy.py",
    ".agents/company/tests/test_runner_persistence.py",
    ".agents/company/tests/test_transient_retry.py",
    ".agents/company/tests/test_acceptance_scope_20260815.py",
]
