...
from company.departments.campaign_contract import COMPATIBLE_SCHEMA_VERSIONS, SCHEMA_VERSION
...
class SharedInterpreterFlowTests(unittest.TestCase):
    ...
    def test_analytics_funnel_requests_report_through_interpreter(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual("analytics-operator", order["employee_id"])
    ...
    def test_outbound_social_research_uses_interpreter_not_custom_stages(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual("social-researcher", order["employee_id"])
