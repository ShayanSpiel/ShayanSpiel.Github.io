...
archetype per item/platform. The selection respects batch rotation: no template
is used twice when the registry can cover the batch; larger batches use balanced
