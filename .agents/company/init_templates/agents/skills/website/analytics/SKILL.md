...
- SEO metadata, structured data, canonicalization, hreflang, sitemap, robots, redirects, or internal linking (see `.agents/skills/website/seo/SKILL.md`)
...
4. `.agents/skills/website/seo/SKILL.md` — SEO invariants (analytics presence check, not implementation)
