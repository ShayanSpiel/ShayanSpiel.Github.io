...
class ClientDeliveryDepartment(EvidenceDepartment, Department):
    ...
    workflows = (
        WorkflowSpec(
            ...
            ('activepieces', 'google-drive'),
            graph=(
                WorkflowStep('intake', 'employee', 'delivery-manager', produces=('order_brief',), requires=(), skill_ids=(), connection_ids=()),
                WorkflowStep('scope', 'employee', 'delivery-manager', produces=('workflow_spec',), requires=('order_brief',), skill_ids=('client-delivery',), connection_ids=()),
                ...
                WorkflowStep('verify_archive', 'employee', 'delivery-manager', produces=('workflow_delivery_record',), requires=('flow_receipt',), skill_ids=('client-delivery',), connection_ids=()),
            ),
        ),
        WorkflowSpec(
            'demo_workflow_build',
            ...
            graph=(
                ...
                WorkflowStep('order_scope_approved', 'approval', None, produces=(), requires=('workflow_spec',), skill_ids=(), connection_ids=()),
                WorkflowStep('build', 'connection', 'workflow-builder', produces=('flow_receipt',), requires=('workflow_spec',), skill_ids=('client-delivery',), connection_ids=('activepieces',)),
                WorkflowStep('verify_archive', 'employee', 'delivery-manager', produces=('demo_delivery_record',), requires=('flow_receipt',), skill_ids=('client-delivery',), connection_ids=()),
            ),
        ),
    )
    goal_schema = {
