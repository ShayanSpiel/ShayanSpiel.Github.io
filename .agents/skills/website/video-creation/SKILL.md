...
- `.agents/company/strategy/icp.md` and `positioning.md` — canonical buyer/positioning (reference, never restate)
...
`.agents/company/departments/design/department.py`; the existing `video-render`
