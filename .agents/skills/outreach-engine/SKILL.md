...
`.agents/company/departments/outbound/`. Campaign data and secrets remain in
`.agents/Outbound/`; runtime ledgers live under `.spielos/state/outbound/`.
...
Every outbound action must run through a persisted engine goal. Live email
