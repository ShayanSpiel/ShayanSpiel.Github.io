...
**LinkedIn (3):**
- `2026-06-06-pillar-linkedin-01.md` — samples "The 4-file architecture" (story-mode)
- `2026-06-06-pillar-linkedin-02.md` — samples "The standalone quality test" (argument-mode)
- `2026-06-06-pillar-linkedin-03.md` — samples "The $5 stack" (argument-mode)

**X (10):**
- `2026-06-06-pillar-tweet-01.md` — the 4-file stack (cheat-code)
- `2026-06-06-pillar-tweet-02.md` — the $5 brag (specific-number)
- `2026-06-06-pillar-tweet-03.md` — the standalone test (cheat-code)
- `2026-06-06-pillar-tweet-04.md` — the pillar method (delete-reframe)
- `2026-06-06-pillar-tweet-05.md` — the LLM is the writer, you are the editor (counter-intuitive)
- `2026-06-06-pillar-tweet-06.md` — the "I do the work, I don't post" confession (confessional)
- `2026-06-06-pillar-tweet-07.md` — the 3-platform model (cheat-code)
- `2026-06-06-pillar-tweet-08.md` — the 4-hour setup (cheat-code)
- `2026-06-06-pillar-tweet-09.md` — the decision tree (cheat-code)
- `2026-06-06-pillar-tweet-10.md` — the post is the byproduct (counter-intuitive)
