...
If you build in public, this is the system. If you don't post about your work, this is the fix. The full [content pipeline for developers](/content-pipeline/) removes the identity switch between building and publishing.
