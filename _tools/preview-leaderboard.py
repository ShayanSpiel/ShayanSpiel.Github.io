...
footer = """<footer role="contentinfo">
  <div class="footer-inner">
    <nav class="footer-social" aria-label="Social links">
      <ul role="list">
        <li role="listitem"><a href="https://x.com/ShayanSpiel" target="_blank" rel="noopener" aria-label="X / Twitter">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
        </a></li>
        <li role="listitem"><a href="https://www.linkedin.com/in/shayantawabi" target="_blank" rel="noopener" aria-label="LinkedIn">
        ...
        <li role="listitem"><a href="https://github.com/ShayanSpiel" target="_blank" rel="noopener" aria-label="GitHub">
        ...
        <li role="listitem"><a href="/feed.xml" aria-label="RSS Feed">
        ...
        <li role="listitem"><a href="mailto:66shayan@gmail.com" aria-label="Email">
